...
sections = rep(sections, '      <div id="thumbs"></div>\n', '')   # 필름스트립(하단 도구바)으로 옮김

# 화면 테마는 내보내기 항목 안으로
sections = rep(sections,
  '      <div class="row"><label class="k">가로 크기</label><select id="expW">',
  '      <div class="row"><label class="k">화면 테마</label><div id="theme">'
  '<button data-t="dark">다크</button><button data-t="system">자동</button><button data-t="light">기본</button>'
  '</div></div>\n'
  '      <div class="row"><label class="k">가로 크기</label><select id="expW">')
...
helpmodal = rep(helpmodal,
  ...
  '<li>맨 아래 <b>[저장]</b> 은 공유창을 띄워 사진 앨범·카톡으로 바로 보냅니다. 파일로 내려받으려면 <b>13. 내보내기</b> 의 <b>이 커버 PNG 저장</b> 을 쓰세요.</li>')
helpmodal = helpmodal.replace('<h3>1 · 사진 넣기</h3>',
  ...
  '      <li>설정은 <b>1. 사진</b> 부터 <b>13. 내보내기</b> 까지 차례로 있습니다. 제목 줄을 누르면 접혀서 건너뛰기 좋습니다.</li>\n'
